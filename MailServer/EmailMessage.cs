...
public class EmailMessage
{
    ...
    private bool isAutoGeneratedProcessedMessage;
    ...
    public bool IsAutoGeneratedProcessedMessage
    {
        get { return isAutoGeneratedProcessedMessage; }
        set { isAutoGeneratedProcessedMessage = value; }
    }
    ...
    private void InitVars()
    {
        ...
        isAutoGeneratedProcessedMessage = false;
                ...
                try
                {
                    using (MemoryStream mainStream = new MemoryStream())
                    {
                        ...
                        else
                        {
                            ...
                            if (attch.FileBytes == null)
                            {
                                processingMessage = "File is empty";
                                exception = false;
                            }
